...
final class PackingFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'gross_weight'    => when($volume, fn () => $this->faker->numberBetween(1000, 100000) / 100),
            'net_weight'      => when($volume, fn () => $this->faker->numberBetween(1000, 100000) / 100),
            'volume'          => when($volume, fn () => $this->faker->numberBetween(1000, 100000) / 100),
