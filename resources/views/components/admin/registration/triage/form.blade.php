...
<div>
    ...
    <x-select.styled :label="__('Risk classification')" :options="[
        ['name' => '🔵 ' . __('Blue - Not urgent'), 'id' => 1],
        ['name' => '🟢 ' . __('Green - Little urgency'), 'id' => 2],
        ['name' => '🟡 ' . __('Yellow - Urgency'), 'id' => 3],
        ['name' => '🟠 ' . __('Orange - Much urgency'), 'id' => 4],
        ['name' => '🔴 ' . __('Red - Emergency'), 'id' => 5],
